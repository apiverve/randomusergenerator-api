// Package randomusergenerator provides a Go client for the Random User Generator API.
//
// For more information, visit: https://apiverve.com/marketplace/randomusergenerator?utm_source=go&utm_medium=readme
...
const (
	baseURL        = "https://api.apiverve.com/v1/randomusergenerator"
	defaultTimeout = 30 * time.Second
)

// Client is the Random User Generator API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Random User Generator API client.
...
// Execute makes a request to the Random User Generator API with typed parameters.
//
...
//   - count: integer - The number of users to generate [min: 1, max: 100]
