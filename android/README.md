# Random User Generator Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:randomusergenerator-api:1.1.13'
}
```
...
```java
import com.apiverve.randomusergenerator.RandomUserGeneratorAPIClient;
import com.apiverve.randomusergenerator.APIResponse;
import com.apiverve.randomusergenerator.APIException;

// Initialize the client
RandomUserGeneratorAPIClient client = new RandomUserGeneratorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/randomusergenerator](https://docs.apiverve.com/ref/randomusergenerator)
...
- **Documentation:** [https://docs.apiverve.com/ref/randomusergenerator](https://docs.apiverve.com/ref/randomusergenerator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/randomusergenerator-api/issues)
