...
class randomusergeneratorWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/randomusergenerator');
        }
        ...
        this.baseURL = 'https://api.apiverve.com/v1/randomusergenerator';

        // Validation rules for parameters (generated from schema)
        this.validationRules = {"count":{"type":"integer","required":false,"min":1,"max":100,"default":1},"includeAvatar":{"type":"boolean","required":false,"default":false}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/randomusergenerator`);
        }
    }
...
module.exports = randomusergeneratorWrapper;
